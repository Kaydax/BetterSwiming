package baguchan.betterswiming.client;

import baguchan.betterswiming.client.model.ModelSwimingPlayer;
...
public class RenderPlayerSwiming extends RenderLivingBase<AbstractClientPlayer> {
    /** this field is used to indicate the 3-pixel wide arms */
    private final boolean smallArms;

    public RenderPlayerSwiming(RenderManager renderManager)
    {
        this(renderManager, false);
    }

    public RenderPlayerSwiming(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new ModelSwimingPlayer(0.0F, useSmallArms), 0.5F);
    ...
    public ModelSwimingPlayer getMainModel()
    {
        return (ModelSwimingPlayer)super.getMainModel();
    }
    ...
    {
        ModelSwimingPlayer modelplayer = this.getMainModel();
    ...
    public void applyRotations(AbstractClientPlayer entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
    {
        ...
        else
        {
            if(entityLiving.isInWater()) {
                ...
                float f3 = this.lerp(entityLiving.rotationPitch, -90.0F - entityLiving.rotationPitch, 1.0F);
